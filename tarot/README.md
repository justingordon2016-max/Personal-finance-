...
Before laying, "How to read it" sets the style, remembered between readings: **Length** (Short, a few lines per card and a one paragraph answer, or Full write up), **Tone** (Gentle or Straight talking) and **The sky** (Leave out, A touch, or Weave it in, which adds an "Under this sky" section reading the moon phase, sun sign, planetary day and hour against the cards).
